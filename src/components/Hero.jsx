  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient 
        ...
        ss:leading-[100px] leading-[75px] w-full'>Paymemt Method.</h1>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a 
          methology to identify the credit cards most likely to fit your
          needs. We examine annual percentage and fees.
        </p>
    </div>
